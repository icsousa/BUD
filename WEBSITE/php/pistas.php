...
<body>
                ...
                <div class="swiper-wrapper">
                    <article class="card__article swiper-slide">
                        ...
                        <div class="card__data">
                            ...
                            <a href="pista.php?id=1" class="card__button">Ver Tempos</a>
                        </div>
                    ...
                    <article class="card__article swiper-slide">
                        ...
                        <div class="card__data">
                            ...
                            <a href="pista.php?id=2" class="card__button">Ver Tempos</a>
                        </div>
                    ...
                    <article class="card__article swiper-slide">
                        ...
                        <div class="card__data">
                            ...
                            <a href="pista.php?id=3" class="card__button">Ver Tempos</a>
                        </div>
                    ...
                    <article class="card__article swiper-slide">
                        ...
                        <div class="card__data">
                            ...
                            <a href="pista.php?id=4" class="card__button">Ver Tempos</a>
                        </div>
    ...
    <script src="script(pistas).js"></script>
